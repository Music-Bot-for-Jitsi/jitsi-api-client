...
import JitsiRemoteTrack from './modules/RTC/JitsiLocalTrack.d.ts';
import JitsiTrack from './modules/RTC/JitsiTrack.d.ts';
import Transcriber from './modules/transcription/transcriber.d.ts';
import JitsiVideoSIPGWSession from './modules/videosipgw/JitsiVideoSIPGWSession.d.ts';
import TraceablePeerConnection from './modules/RTC/TraceablePeerConnection.d.ts';
...
export default class JitsiConference {
  ...
  onCallAccepted: ( session: unknown, answer: any ) => void; // TODO: answer is a jQuery object, unknown = JingleSessionPC which doesn't exist
  onTransportInfo: ( session: unknown, transportInfo: any ) => void; // TODO: transportInfo is a jQuery object, unknown = JingleSessionPC which doesn't exist
